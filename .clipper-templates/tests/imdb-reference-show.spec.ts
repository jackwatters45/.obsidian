...
const TEST_URL = "https://www.imdb.com/title/tt0944947/reference/";
const template = loadTemplate("imdb-reference-show-clipper");

test.describe("IMDB Reference Show Clipper", () => {
