...
const TEST_URL = "https://www.imdb.com/title/tt0133093/reference/";
const template = loadTemplate("imdb-reference-movie-clipper");

test.describe("IMDB Reference Movie Clipper", () => {
