...
const TEST_URL = "https://open.spotify.com/album/4LH4d3cOWNNsVw41Gqt2kv";
const template = loadTemplate("spotify-album-clipper");

test.describe("Spotify Album Clipper", () => {
